...
[← Home](Home.ko.md) · [원칙](task_principle.ko.md) · [test_agent](test_agent.ko.md) · [ci_trigger](ci_trigger.ko.md) · [pipeline](UX_E2E_CI_plan.ko.md)
...
- **out-of-scope**: E2E 스크립트(→ [test_agent](test_agent.ko.md)), 코드·UI 디자인 변경, CI 워크플로 변경, 다른 모듈 직접 호출.
...
- **out**: 갱신된 doc
- **event**: emit `doc_updated` → 소비자: [test_agent](test_agent.ko.md)
